...
import { Modal, Button, Form, Input, Select, Upload, Typography } from "antd";
import {
  PlusOutlined,
  UploadOutlined,
  DownloadOutlined,
    ...
    <div className="bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        {publications.length === 0 ? (
          <div className="py-24">
            <Text type="secondary">Hozircha nashrlar mavjud emas</Text>
          </div>
        ) : (
            ...
            {publications.map((item, index) => (
              ...
              >
                ...
                <div className="flex gap-6">
                  {/* Gradient raqam */}
                  <div className="flex items-center justify-center w-10 h-10 text-white text-sm font-bold bg-gradient-to-br from-blue-500 to-sky-600 rounded-xl shadow">
                    {index + 1}
                  </div>
        ...
        {/* MODAL — dizayn */}
        <Modal
          title={<Title level={3}>Yangi nashr qo‘shish</Title>}
          open={isOpen}
          onCancel={closeModal}
          footer={null}
          width={720}
        ...
        >
          <Form form={form} layout="vertical">
            <div className="grid grid-cols-1 gap-4">
              ...
              >
                <Input size="large" placeholder="Nashr sarlavhasi..." />
              </Form.Item>
